	...
	if usr_cmd == "/start":
			...
			try:
				...
				if user.status == "kicked":
					await bot.send_message(
						...
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/ExploitzBotsChat).",
						parse_mode="markdown",
		...
		await cmd.reply_text(
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Support Group", url="https://t.me/ExploitzBotsChat"),
						InlineKeyboardButton("Bots Channel", url="https://t.me/ExploitzBots")
					],
					[
			...
			try:
				...
				await bot.send_message(
					...
					reply_markup=InlineKeyboardMarkup(
						[
							[
								InlineKeyboardButton("🤖 Join Updates Channel", url="https://t.me/ExploitzBots")
							],
							[
	...
	if "aboutbot" in cb_data:
		await cmd.message.edit(
			...
			reply_markup=InlineKeyboardMarkup(
				[
					[
						InlineKeyboardButton("Owner", url="https://t.me/ExploitzBots")
					],
					[
		...
		if Config.UPDATES_CHANNEL:
			...
			try:
				...
				await cmd.message.edit(
					text="Something went Wrong. Contact my [Support Group](https://t.me/ExploitzBotsChat).",
					parse_mode="markdown",
					disable_web_page_preview=True
				)
				return
